...
export const LISTEN_BOOKING = 'LISTEN_BOOKING'
export const LISTEN_CONFIRMATION = 'LISTEN_CONFIRMATION'
export const LISTEN_MARKETING = 'LISTEN_MARKETING'
export const LISTEN_MARKET_CONFIRMATION = 'LISTEN_MARKET_CONFIRMATION'
export const LISTEN_REVIEWING = 'LISTEN_REVIEWING'
export const LOADING_REVIEWS = 'LOADING_REVIEWS'
export const DEFAULT_CLOSING = 'DEFAULT_CLOSING'
